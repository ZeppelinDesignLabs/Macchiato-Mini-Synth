...
return (int) (((long) gain_adsr1 * lpf1.next(wav1) + (long) gain_adsr2 * lpf2.next(wav2)) >> 3);  
}
...
void HandlePitchBend (byte channel, int bend){
  float pitchBend = PitchBend(bend);
